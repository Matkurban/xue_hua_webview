...
WindowsLoadRequestData::WindowsLoadRequestData(
...
const std::string& WindowsLoadRequestData::url() const {
  return url_;
}
...
const std::string& WindowsLoadRequestData::method() const {
  return method_;
}
...
const std::string& WindowsLoadRequestData::headers() const {
  return headers_;
}
...
void WindowsLoadRequestData::set_body(const std::vector<uint8_t>* value_arg) {
  body_ = value_arg ? std::optional<std::vector<uint8_t>>(*value_arg) : std::nullopt;
}
...
WindowsLoadRequestData WindowsLoadRequestData::FromEncodableList(const EncodableList& list) {
  WindowsLoadRequestData decoded(
    std::get<std::string>(list[0]),
    std::get<std::string>(list[1]),
    std::get<std::string>(list[2]));
...
bool WindowsLoadRequestData::operator==(const WindowsLoadRequestData& other) const {
  return PigeonInternalDeepEquals(url_, other.url_) && PigeonInternalDeepEquals(method_, other.method_) && PigeonInternalDeepEquals(headers_, other.headers_) && PigeonInternalDeepEquals(body_, other.body_);
}
...
EncodableValue PigeonInternalCodecSerializer::ReadValueOfType(
  ...
  switch (type) {
    ...
    case 137: {
        return CustomEncodableValue(WindowsLoadRequestData::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    default:
...
void PigeonInternalCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value = std::get_if<CustomEncodableValue>(&value)) {
    ...
    if (custom_value->type() == typeid(WindowsLoadRequestData)) {
      ...
      WriteValue(EncodableValue(std::any_cast<WindowsLoadRequestData>(*custom_value).ToEncodableList()), stream);
      return;
    }
  }
...
void WindowsWebViewHostApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.initializeEnvironment" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.getWebViewVersion" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.openWebView2DownloadPage" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          std::optional<FlutterError> output = api->OpenWebView2DownloadPage();
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.createWebView" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.disposeWebView" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.loadUrl" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.loadRequest" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& request_arg = std::any_cast<const WindowsLoadRequestData&>(std::get<CustomEncodableValue>(encodable_request_arg));
          std::optional<FlutterError> output = api->LoadRequest(texture_id_arg, request_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.loadStringContent" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.reload" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.stop" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.goBack" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.goForward" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.addScriptToExecuteOnDocumentCreated" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.removeScriptToExecuteOnDocumentCreated" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.executeScript" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.postWebMessage" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setUserAgent" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto* user_agent_arg = std::get_if<std::string>(&encodable_user_agent_arg);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.getUserAgent" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const int64_t texture_id_arg = encodable_texture_id_arg.LongValue();
          ErrorOr<std::optional<std::string>> output = api->GetUserAgent(texture_id_arg);
          if (output.has_error()) {
            reply(WrapError(output.error()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setJavaScriptEnabled" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          std::optional<FlutterError> output = api->SetJavaScriptEnabled(texture_id_arg, enabled_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.clearCookies" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setCookie" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.getCookies" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.deleteCookie" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.deleteCookiesWithNameAndUrl" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.deleteCookiesWithNameDomainAndPath" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.clearCache" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.clearLocalStorage" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const int64_t texture_id_arg = encodable_texture_id_arg.LongValue();
          api->ClearLocalStorage(texture_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setCacheDisabled" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.openDevTools" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setBackgroundColor" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setZoomControlEnabled" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& enabled_arg = std::get<bool>(encodable_enabled_arg);
          std::optional<FlutterError> output = api->SetZoomControlEnabled(texture_id_arg, enabled_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setZoomFactor" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setPopupWindowPolicy" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setNavigationRequestCallbacksEnabled" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& enabled_arg = std::get<bool>(encodable_enabled_arg);
          std::optional<FlutterError> output = api->SetNavigationRequestCallbacksEnabled(texture_id_arg, enabled_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setJavaScriptDialogCallbacksEnabled" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          std::optional<FlutterError> output = api->SetJavaScriptDialogCallbacksEnabled(texture_id_arg, alert_arg, confirm_arg, prompt_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.suspend" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.resume" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setVirtualHostNameMapping" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.clearVirtualHostNameMapping" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setFpsLimit" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setPointerUpdate" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setCursorPos" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setPointerButton" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setScrollDelta" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setSize" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.xue_hua_webview_windows.WindowsWebViewHostApi.setSurfaceAttached" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          std::optional<FlutterError> output = api->SetSurfaceAttached(texture_id_arg, attached_arg);
          if (output.has_value()) {
            reply(WrapError(output.value()));
            return;
          }
