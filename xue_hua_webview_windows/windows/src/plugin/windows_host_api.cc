...
namespace xue_hua_webview_windows {
namespace {
...
void WindowsHostApi::RegisterWithRegistrar(
  ...
  xue_hua_webview_windows::WindowsWebViewHostApi::SetUp(registrar->messenger(),
                                                    plugin.get());
...
WindowsHostApi::~WindowsHostApi() {
  ...
  xue_hua_webview_windows::WindowsWebViewHostApi::SetUp(messenger_, nullptr);
  instances_.clear();
...
std::optional<xue_hua_webview_windows::FlutterError>
WindowsHostApi::InitializeEnvironment(
    const xue_hua_webview_windows::WindowsEnvironmentOptions &options) {
  if (webview_host_) {
    return xue_hua_webview_windows::FlutterError(
        kErrorCodeEnvironmentAlreadyInitialized,
        "The webview environment is already initialized");
  }

  if (!InitPlatform()) {
    return xue_hua_webview_windows::FlutterError(kErrorUnsupportedPlatform,
...
xue_hua_webview_windows::ErrorOr<std::optional<std::string>>
...
void WindowsHostApi::CreateWebView(
    std::function<void(xue_hua_webview_windows::ErrorOr<
                       xue_hua_webview_windows::WindowsCreateWebViewResult>
                           reply)>
        result) {
  if (parent_window_ == nullptr || !IsWindow(parent_window_)) {
    return result(xue_hua_webview_windows::FlutterError(
  ...
  webview_host_->CreateWebview(
      ...
      [lifetime_state = lifetime_state_, result = std::move(result)](
        ...
        result(xue_hua_webview_windows::WindowsCreateWebViewResult(texture_id));
      });
}
...
WindowsHostApi::DisposeWebView(int64_t texture_id) {
  ...
  return xue_hua_webview_windows::FlutterError(kErrorCodeInvalidId);
}
...
WindowsHostApi::MethodFailedError(const std::string &message) {
  return xue_hua_webview_windows::FlutterError(kErrorMethodFailed, message);
}
...
std::optional<xue_hua_webview_windows::FlutterError> WindowsHostApi::LoadRequest(
    int64_t texture_id,
    const xue_hua_webview_windows::WindowsLoadRequestData &request) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
void WindowsHostApi::AddScriptToExecuteOnDocumentCreated(
    ...
    std::function<
        void(xue_hua_webview_windows::ErrorOr<std::optional<std::string>> reply)>
        result) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return result(xue_hua_webview_windows::FlutterError(kErrorCodeInvalidId));
  }
...
void WindowsHostApi::ExecuteScript(
    int64_t texture_id, const std::string &script,
    std::function<void(xue_hua_webview_windows::ErrorOr<std::string> reply)>
        result) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return result(xue_hua_webview_windows::FlutterError(kErrorCodeInvalidId));
...
WindowsHostApi::PostWebMessage(int64_t texture_id, const std::string &message) {
  ...
  if (!bridge->PostWebMessage(message)) {
    return xue_hua_webview_windows::FlutterError(kErrorNotSupported,
...
void WindowsHostApi::ClearCookies(
    int64_t texture_id,
    std::function<void(xue_hua_webview_windows::ErrorOr<bool> reply)> result) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return result(xue_hua_webview_windows::FlutterError(kErrorCodeInvalidId));
  }
  bridge->ClearCookies(
      [result = std::move(result)](bool success, bool had_cookies) mutable {
        ...
        return result(xue_hua_webview_windows::FlutterError(kErrorMethodFailed));
      });
}

std::optional<xue_hua_webview_windows::FlutterError> WindowsHostApi::SetCookie(
    int64_t texture_id, const xue_hua_webview_windows::WindowsCookieData &cookie) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
void WindowsHostApi::GetCookies(
    ...
    std::function<
        void(xue_hua_webview_windows::ErrorOr<flutter::EncodableList> reply)>
        result) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return result(xue_hua_webview_windows::FlutterError(kErrorCodeInvalidId));
  ...
  bridge->GetCookies(url, [result = std::move(result)](
    ...
    for (const auto &cookie : cookies) {
      ...
      encoded_cookies.push_back(
          flutter::CustomEncodableValue(xue_hua_webview_windows::WindowsCookieData(
...
std::optional<xue_hua_webview_windows::FlutterError> WindowsHostApi::DeleteCookie(
    int64_t texture_id, const xue_hua_webview_windows::WindowsCookieData &cookie) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
...
void WindowsHostApi::ClearLocalStorage(
    int64_t texture_id,
    std::function<void(std::optional<xue_hua_webview_windows::FlutterError> reply)>
        result) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
  ...
  bridge->ClearLocalStorage([result = std::move(result)](bool success) mutable {
    ...
    result(xue_hua_webview_windows::FlutterError(kErrorMethodFailed));
  });
}
...
WindowsHostApi::SetVirtualHostNameMapping(
    int64_t texture_id,
    const xue_hua_webview_windows::WindowsVirtualHostMappingData &mapping) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
WindowsHostApi::SetPointerUpdate(
    int64_t texture_id,
    const xue_hua_webview_windows::WindowsPointerUpdateData &update) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
std::optional<xue_hua_webview_windows::FlutterError> WindowsHostApi::SetCursorPos(
    int64_t texture_id, const xue_hua_webview_windows::WindowsPointData &position) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
WindowsHostApi::SetPointerButton(
    int64_t texture_id,
    const xue_hua_webview_windows::WindowsPointerButtonData &button) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
std::optional<xue_hua_webview_windows::FlutterError> WindowsHostApi::SetScrollDelta(
    int64_t texture_id, const xue_hua_webview_windows::WindowsPointData &delta) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
...
WindowsHostApi::SetSize(int64_t texture_id,
                        const xue_hua_webview_windows::WindowsSizeData &size) {
  auto bridge = FindBridge(texture_id);
  if (!bridge) {
    return InvalidIdError();
  }
