...
void main() {
  ...
  test(
    'Default implementation of runJavaScriptAsync should throw unimplemented error',
    () {
      final PlatformWebViewController controller =
          ExtendsPlatformWebViewController(
            const PlatformWebViewControllerCreationParams(),
      ...
      expect(
        () => controller.runJavaScriptAsync('return 1;'),
        throwsUnimplementedError,
      );
    },
  );
  ...
  test(
    'Default implementation of addUserScript should throw unimplemented error',
    () {
      final PlatformWebViewController controller =
          ExtendsPlatformWebViewController(
            const PlatformWebViewControllerCreationParams(),
      ...
      expect(
        () => controller.addUserScript(const UserScript(source: 'void 0;')),
        throwsUnimplementedError,
      );
    },
  );
  ...
  test(
    'Default implementation of removeAllUserScripts should throw unimplemented error',
    () {
      final PlatformWebViewController controller =
          ExtendsPlatformWebViewController(
            const PlatformWebViewControllerCreationParams(),
      ...
      expect(controller.removeAllUserScripts, throwsUnimplementedError);
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(controller.dispose, throwsUnimplementedError);
    },
  );
}
