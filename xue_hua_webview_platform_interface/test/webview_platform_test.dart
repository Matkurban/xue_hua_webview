...
void main() {
  ...
  test(
    'Default implementation of createPlatformStorageManager should throw unimplemented error',
    () {
      final WebViewPlatform webViewPlatform = ExtendsWebViewPlatform();

      expect(
        () => webViewPlatform.createPlatformStorageManager(
          const PlatformWebViewStorageManagerCreationParams(),
        ),
        throwsUnimplementedError,
      );
  ...
  test(
    'Default implementation of createPlatformHeadlessWebView should throw unimplemented error',
    () {
      final WebViewPlatform webViewPlatform = ExtendsWebViewPlatform();

      expect(
        () => webViewPlatform.createPlatformHeadlessWebView(
          const PlatformHeadlessWebViewCreationParams(),
        ),
        throwsUnimplementedError,
      );
