...
void main() {
  test(
    'ensures xue_hua_webview_platform_interface.dart exports classes in types directory',
    () {
      main_file.JavaScriptAsyncResult;
      ...
      main_file.PlatformHeadlessWebViewCreationParams;
      ...
      main_file.PlatformWebViewStorageManagerCreationParams;
      main_file.PlatformWebViewWidgetCreationParams;
      main_file.ProgressCallback;
      main_file.UserScript;
      main_file.UserScriptInjectionTime;
