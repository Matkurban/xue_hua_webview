...
class LinuxWebViewController extends PlatformWebViewController
  ...
  void _reportEventError(
    ...
    debugPrint('xue_hua_webview_linux: $operation failed: $error');
  }
  ...
  Object? _decodeOptionalJsResult(Object? result) {
    if (result == null) {
      return null;
    }
    if (result case final Map<Object?, Object?> map
        when map['__json__'] is String) {
      return jsonDecode(map['__json__']! as String);
    }
    return result;
  }
  ...
  Future<void> addUserScript(UserScript userScript) {
    return _invoke<void>('addUserScript', <String, Object?>{
      'source': userScript.source,
      'atDocumentStart':
          userScript.injectionTime == UserScriptInjectionTime.documentStart,
  ...
  Future<void> removeAllUserScripts() {
    return _invoke<void>('removeAllUserScripts');
  }
