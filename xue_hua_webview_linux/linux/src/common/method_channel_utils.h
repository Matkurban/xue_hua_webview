#ifndef XUE_HUA_WEBVIEW_LINUX_METHOD_CHANNEL_UTILS_H_
#define XUE_HUA_WEBVIEW_LINUX_METHOD_CHANNEL_UTILS_H_
...
#endif  // XUE_HUA_WEBVIEW_LINUX_METHOD_CHANNEL_UTILS_H_
