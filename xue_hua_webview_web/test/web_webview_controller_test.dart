...
void main() {
  ...
  group('WebWebViewController', () {
    ...
    group('loadHtmlString', () {
      ...
      test('loadHtmlString injects document-start user scripts', () async {
        final controller = WebWebViewController(
          WebWebViewControllerCreationParams(),
        );
...
''');
    ...
    group('permissions', () {
      ...
      test('rejects forged in-frame permission decisions', () async {
        ...
        await controller.runJavaScript('''
          window.postMessage({
            "__xue_hua_webview_type": "platformPermissionDecision",
