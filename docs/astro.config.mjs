...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      editLink: {
        baseUrl: 'https://github.com/Matkurban/xue_hua_webview/edit/main/docs/',
      },
      social: [
        {
          icon: 'github',
          label: 'GitHub',
          href: 'https://github.com/Matkurban/xue_hua_webview',
        },
      ],
      sidebar: [
        {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Contributing',
              translations: { 'zh-CN': '贡献与规范' },
              slug: 'release/contributing',
            },
          ],
        },
      ],
