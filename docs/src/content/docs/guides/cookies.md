...
To clear cookies together with cache and DOM storage, use
`WebViewStorageManager().removeData()`; it does not require a live controller.
On web this only affects the host origin.
