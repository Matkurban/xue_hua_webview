...
class WebViewController {
  ...
  Future<JavaScriptAsyncResult> runJavaScriptAsync(
    ...
    return platform.runJavaScriptAsync(
      functionBody,
      arguments: arguments,
      timeout: timeout,
    );
  ...
  /// Injects [userScript] into every subsequent navigation, at document start
  /// or document end.
  ...
  ///
  /// A disposed controller cannot be reused. Removing a [WebViewWidget] does
  /// not call this method because a controller can be detached and mounted
  /// again.
  Future<void> dispose() {
