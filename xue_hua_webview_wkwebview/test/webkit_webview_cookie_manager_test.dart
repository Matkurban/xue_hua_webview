...
void main() {
  ...
  group('WebKitWebViewStorageManager', () {
    test('removeData maps cookies to WKWebsiteDataStore', () async {
      final mockWKWebsiteDataStore = MockWKWebsiteDataStore();
      PigeonOverrides.wKWebsiteDataStore_defaultDataStore =
          mockWKWebsiteDataStore;
      when(
        mockWKWebsiteDataStore.removeDataOfTypes(any, any),
      ).thenAnswer((_) async => true);

      final WebKitWebViewStorageManager manager = WebKitWebViewStorageManager(
