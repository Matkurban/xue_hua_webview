...
import 'webkit_headless_webview.dart';
import 'webkit_webview_storage_manager.dart';
...
class WebKitWebViewPlatform extends WebViewPlatform {
  ...
  @override
  WebKitWebViewStorageManager createPlatformStorageManager(
    PlatformWebViewStorageManagerCreationParams params,
  ) {
    return WebKitWebViewStorageManager(params);
  }

  @override
  WebKitHeadlessWebView createPlatformHeadlessWebView(
    PlatformHeadlessWebViewCreationParams params,
  ) {
    return WebKitHeadlessWebView(params);
  }
}
