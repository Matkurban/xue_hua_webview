...
class NSObjectImpl: NSObject {
    ...
    static func handleObserveValue(
        ...
        of object: Any?, change: [NSKeyValueChangeKey: Any]?, context _: UnsafeMutableRawPointer?
    ) {
...
class NSObjectProxyAPIDelegate: PigeonApiDelegateNSObject {
    ...
    func addObserver(
        pigeonApi _: PigeonApiNSObject, pigeonInstance: NSObject, observer: NSObject, keyPath: String,
