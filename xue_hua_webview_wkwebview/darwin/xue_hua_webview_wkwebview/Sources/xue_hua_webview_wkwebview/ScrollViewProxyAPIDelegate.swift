...
class ScrollViewProxyAPIDelegate: PigeonApiDelegateUIScrollView {
    #if os(iOS)
        func getContentOffset(pigeonApi _: PigeonApiUIScrollView, pigeonInstance: UIScrollView) throws
            -> [Double]
        {
        ...
        func scrollBy(
            pigeonApi _: PigeonApiUIScrollView, pigeonInstance: UIScrollView, x: Double, y: Double
        ) throws {
            let offset = pigeonInstance.contentOffset
        ...
        func setDelegate(
            pigeonApi _: PigeonApiUIScrollView, pigeonInstance: UIScrollView,
            delegate: UIScrollViewDelegate?
        ) throws {
            pigeonInstance.delegate = delegate
        }

        func setBounces(pigeonApi _: PigeonApiUIScrollView, pigeonInstance: UIScrollView, value: Bool)
            throws
        {
        ...
        func setAlwaysBounceVertical(
            pigeonApi _: PigeonApiUIScrollView, pigeonInstance: UIScrollView, value: Bool
        ) throws {
