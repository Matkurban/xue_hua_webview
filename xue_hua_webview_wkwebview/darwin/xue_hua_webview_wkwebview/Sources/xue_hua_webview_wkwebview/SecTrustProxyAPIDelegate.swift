...
class SecTrustProxyAPIDelegate: PigeonApiDelegateSecTrust {
    func evaluateWithError(
        pigeonApi _: PigeonApiSecTrust, trust: SecTrustWrapper,
    ...
    func copyExceptions(pigeonApi _: PigeonApiSecTrust, trust: SecTrustWrapper) throws
    ...
    func setExceptions(
        pigeonApi _: PigeonApiSecTrust, trust: SecTrustWrapper, exceptions: FlutterStandardTypedData?
    ) throws -> Bool {
        let data: CFData? = exceptions != nil ? exceptions!.data as CFData : nil
        return secTrustSetExceptions(trust.value, data)
    }

    func getTrustResult(pigeonApi _: PigeonApiSecTrust, trust: SecTrustWrapper) throws
    ...
    func copyCertificateChain(pigeonApi _: PigeonApiSecTrust, trust: SecTrustWrapper) throws
