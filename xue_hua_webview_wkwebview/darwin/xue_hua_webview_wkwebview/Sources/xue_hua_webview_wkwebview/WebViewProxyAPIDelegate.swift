    ...
    PigeonApiDelegateNSViewWKWebView
{
    ...
    #if os(iOS)
        func scrollView(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws
            -> UIScrollView
        {
    ...
    func pigeonDefaultConstructor(
        ...
        #if os(macOS)
            SafariUserAgent.applyCompatibilityNameIfNeeded(to: initialConfiguration)
        #endif
        return WebViewImpl(
    ...
    func configuration(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView)
    ...
    func setUIDelegate(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, delegate: WKUIDelegate
    ) throws {
    ...
    func setNavigationDelegate(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, delegate: WKNavigationDelegate
    ) throws {
    ...
    func getUrl(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws -> String? {
    ...
    func getEstimatedProgress(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws
        -> Double
    {
    ...
    func load(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, request: URLRequestWrapper
    ) throws {
    ...
    func loadHtmlString(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, string: String, baseUrl: String?
    ) throws {
    ...
    func loadFileUrl(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, url: String,
    ...
    func canGoBack(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws -> Bool {
    ...
    func canGoForward(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws -> Bool {
    ...
    func goBack(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws {
    ...
    func goForward(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws {
    ...
    func reload(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws {
    ...
    func getTitle(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws -> String? {
    ...
    func setAllowsBackForwardNavigationGestures(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, allow: Bool
    ) throws {
    ...
    func setCustomUserAgent(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, userAgent: String?
    ) throws {
    ...
    func evaluateJavaScript(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, javaScriptString: String,
    ...
    func callAsyncJavaScript(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, functionBody: String,
        ...
        if #available(iOS 14.0, macOS 11.0, *) {
            ...
            let pigeonError = PigeonError(
                code: "FWFUnsupportedError",
                message: "callAsyncJavaScript requires iOS 14 or macOS 11.",
                details: nil
            )
            completion(.failure(pigeonError))
        }
    ...
    func setInspectable(
        pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, inspectable: Bool
    ) throws -> Bool {
    ...
    func setUnderPageBackgroundColor(
        pigeonApi _: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, red: Double, green: Double,
    ...
    func setAllowsMagnification(
        pigeonApi _: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, allow: Bool
    ) throws {
        #if os(macOS)
    ...
    func getCustomUserAgent(pigeonApi _: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView) throws
        -> String?
    {
