...
class GetTrustResultResponseProxyAPIDelegate: PigeonApiDelegateGetTrustResultResponse {
    func result(pigeonApi _: PigeonApiGetTrustResultResponse, pigeonInstance: GetTrustResultResponse)
    ...
    func resultCode(
        pigeonApi _: PigeonApiGetTrustResultResponse, pigeonInstance: GetTrustResultResponse
    ) throws -> Int64 {
