...
final class WebKitLibraryPigeonInternalFinalizer {
    ...
    weak var delegate: WebKitLibraryPigeonInternalFinalizerDelegate?
...
final class WebKitLibraryPigeonInstanceManager {
    ...
    init(finalizerDelegate: WebKitLibraryPigeonInternalFinalizerDelegate) {
...
private class WebKitLibraryPigeonInstanceManagerApi {
    ...
    var codec: FlutterStandardMessageCodec {
        WebKitLibraryPigeonCodec.shared
    }
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, instanceManager: WebKitLibraryPigeonInstanceManager?) {
        ...
        let removeStrongReferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.PigeonInternalInstanceManager.removeStrongReference", binaryMessenger: binaryMessenger, codec: codec)
        ...
        let clearChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.PigeonInternalInstanceManager.clear", binaryMessenger: binaryMessenger, codec: codec)
        if let instanceManager = instanceManager {
    ...
    func removeStrongReference(identifier identifierArg: Int64, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.PigeonInternalInstanceManager.removeStrongReference"
...
open class WebKitLibraryPigeonProxyApiRegistrar {
    ...
    init(binaryMessenger: FlutterBinaryMessenger, apiDelegate: WebKitLibraryPigeonProxyApiDelegate) {
        ...
        instanceManager = WebKitLibraryPigeonInstanceManager(
    ...
    private class WebKitLibraryPigeonInternalProxyApiCodecWriter: WebKitLibraryPigeonCodecWriter {
        ...
        override func writeValue(_ value: Any) {
            ...
            if let instance = value as AnyObject?, pigeonRegistrar.instanceManager.containsInstance(instance) {
                ...
                assertionFailure("Unsupported value for WebKitLibraryPigeonInternalProxyApiCodecWriter")
            }
        }
    }
...
final class PigeonApiURLRequest: PigeonApiProtocolURLRequest {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURLRequest?) {
        ...
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, url: urlArg),
        ...
        let getUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.getUrl", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setHttpMethodChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.setHttpMethod", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getHttpMethodChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.getHttpMethod", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setHttpBodyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.setHttpBody", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getHttpBodyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.getHttpBody", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setAllHttpHeaderFieldsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.setAllHttpHeaderFields", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getAllHttpHeaderFieldsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.getAllHttpHeaderFields", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: URLRequestWrapper, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLRequest.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiHTTPURLResponse: PigeonApiProtocolHTTPURLResponse {
    ...
    func pigeonNewInstance(pigeonInstance: HTTPURLResponse, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.HTTPURLResponse.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiURLResponse: PigeonApiProtocolURLResponse {
    ...
    func pigeonNewInstance(pigeonInstance: URLResponse, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLResponse.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKUserScript: PigeonApiProtocolWKUserScript {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKUserScript?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserScript.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, source: sourceArg, injectionTime: injectionTimeArg, isForMainFrameOnly: isForMainFrameOnlyArg),
                        withIdentifier: pigeonIdentifierArg
                    )
                    reply(wrapResult(nil))
                } catch {
    ...
    func pigeonNewInstance(pigeonInstance: WKUserScript, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserScript.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKNavigationAction: PigeonApiProtocolWKNavigationAction {
    ...
    func pigeonNewInstance(pigeonInstance: WKNavigationAction, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationAction.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKNavigationResponse: PigeonApiProtocolWKNavigationResponse {
    ...
    func pigeonNewInstance(pigeonInstance: WKNavigationResponse, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationResponse.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKFrameInfo: PigeonApiProtocolWKFrameInfo {
    ...
    func pigeonNewInstance(pigeonInstance: WKFrameInfo, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKFrameInfo.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiNSError: PigeonApiProtocolNSError {
    ...
    func pigeonNewInstance(pigeonInstance: NSError, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSError.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKScriptMessage: PigeonApiProtocolWKScriptMessage {
    ...
    func pigeonNewInstance(pigeonInstance: WKScriptMessage, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKScriptMessage.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKSecurityOrigin: PigeonApiProtocolWKSecurityOrigin {
    ...
    func pigeonNewInstance(pigeonInstance: WKSecurityOrigin, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKSecurityOrigin.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiHTTPCookie: PigeonApiProtocolHTTPCookie {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiHTTPCookie?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.HTTPCookie.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, properties: propertiesArg!),
                        withIdentifier: pigeonIdentifierArg
                    )
                    reply(wrapResult(nil))
                } catch {
        ...
        let getPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.HTTPCookie.getProperties", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: HTTPCookie, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.HTTPCookie.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiAuthenticationChallengeResponse: PigeonApiProtocolAuthenticationChallengeResponse {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAuthenticationChallengeResponse?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.AuthenticationChallengeResponse.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, disposition: dispositionArg, credential: credentialArg),
                        withIdentifier: pigeonIdentifierArg
                    )
                    reply(wrapResult(nil))
                } catch {
        ...
        let createAsyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.AuthenticationChallengeResponse.createAsync", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: AuthenticationChallengeResponse, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.AuthenticationChallengeResponse.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKWebsiteDataStore: PigeonApiProtocolWKWebsiteDataStore {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKWebsiteDataStore?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let defaultDataStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebsiteDataStore.defaultDataStore", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            defaultDataStoreChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.pigeonDelegate.defaultDataStore(pigeonApi: api), withIdentifier: pigeonIdentifierArg)
                    reply(wrapResult(nil))
                } catch {
                    reply(wrapError(error))
                }
        ...
        let httpCookieStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebsiteDataStore.httpCookieStore", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            httpCookieStoreChannel.setMessageHandler { message, reply in
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.pigeonDelegate.httpCookieStore(pigeonApi: api, pigeonInstance: pigeonInstanceArg), withIdentifier: pigeonIdentifierArg)
                    reply(wrapResult(nil))
                } catch {
                    reply(wrapError(error))
                }
        ...
        let removeDataOfTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebsiteDataStore.removeDataOfTypes", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKWebsiteDataStore, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebsiteDataStore.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIView?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(macOS)
            let setBackgroundColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIView.setBackgroundColor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setOpaqueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIView.setOpaque", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        func pigeonNewInstance(pigeonInstance: UIView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIView.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIScrollView?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(macOS)
            let getContentOffsetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.getContentOffset", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let scrollByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.scrollBy", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setContentOffsetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setContentOffset", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setDelegate", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setBouncesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setBounces", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setBouncesHorizontallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setBouncesHorizontally", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setBouncesVerticallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setBouncesVertically", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setAlwaysBounceVerticalChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setAlwaysBounceVertical", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setAlwaysBounceHorizontalChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setAlwaysBounceHorizontal", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setShowsVerticalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setShowsVerticalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setShowsHorizontalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.setShowsHorizontalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        func pigeonNewInstance(pigeonInstance: UIScrollView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollView.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateWKWebViewConfiguration {
    ...
    func setLimitsNavigationsToAppBoundDomains(pigeonApi: PigeonApiWKWebViewConfiguration, pigeonInstance: WKWebViewConfiguration, limit: Bool) throws -> Bool
    /// The media types that require a user gesture to begin playing.
...
final class PigeonApiWKWebViewConfiguration: PigeonApiProtocolWKWebViewConfiguration {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKWebViewConfiguration?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api),
                        withIdentifier: pigeonIdentifierArg
                    )
                    reply(wrapResult(nil))
                } catch {
        ...
        let setUserContentControllerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setUserContentController", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getUserContentControllerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.getUserContentController", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setWebsiteDataStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setWebsiteDataStore", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getWebsiteDataStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.getWebsiteDataStore", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setPreferencesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setPreferences", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getPreferencesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.getPreferences", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setAllowsInlineMediaPlaybackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setAllowsInlineMediaPlayback", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setLimitsNavigationsToAppBoundDomainsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setLimitsNavigationsToAppBoundDomains", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            setLimitsNavigationsToAppBoundDomainsChannel.setMessageHandler { message, reply in
                ...
                do {
                    let result = try api.pigeonDelegate.setLimitsNavigationsToAppBoundDomains(pigeonApi: api, pigeonInstance: pigeonInstanceArg, limit: limitArg)
                    reply(wrapResult(result))
                } catch {
                    reply(wrapError(error))
                }
        ...
        let setMediaTypesRequiringUserActionForPlaybackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.setMediaTypesRequiringUserActionForPlayback", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getDefaultWebpagePreferencesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.getDefaultWebpagePreferences", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKWebViewConfiguration, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebViewConfiguration.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKUserContentController: PigeonApiProtocolWKUserContentController {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKUserContentController?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let addScriptMessageHandlerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.addScriptMessageHandler", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let removeScriptMessageHandlerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.removeScriptMessageHandler", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let removeAllScriptMessageHandlersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.removeAllScriptMessageHandlers", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addUserScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.addUserScript", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let removeAllUserScriptsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.removeAllUserScripts", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKUserContentController, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUserContentController.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKPreferences: PigeonApiProtocolWKPreferences {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKPreferences?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let setJavaScriptEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKPreferences.setJavaScriptEnabled", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setJavaScriptCanOpenWindowsAutomaticallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKPreferences.setJavaScriptCanOpenWindowsAutomatically", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKPreferences, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKPreferences.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKScriptMessageHandler: PigeonApiProtocolWKScriptMessageHandler {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKScriptMessageHandler?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKScriptMessageHandler.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
    ...
    func didReceiveScriptMessage(pigeonInstance pigeonInstanceArg: WKScriptMessageHandler, controller controllerArg: WKUserContentController, message messageArg: WKScriptMessage, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKScriptMessageHandler.didReceiveScriptMessage"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKNavigationDelegate: PigeonApiProtocolWKNavigationDelegate {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKNavigationDelegate?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
    ...
    func didFinishNavigation(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, url urlArg: String?, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.didFinishNavigation"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func didStartProvisionalNavigation(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, url urlArg: String?, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.didStartProvisionalNavigation"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
        channel.sendMessage([pigeonInstanceArg, webViewArg, urlArg] as [Any?]) { response in
            guard let listResponse = response as? [Any?] else {
                completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    func decidePolicyForNavigationAction(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, navigationAction navigationActionArg: WKNavigationAction, completion: @escaping (Result<NavigationActionPolicy, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.decidePolicyForNavigationAction"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func decidePolicyForNavigationResponse(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, navigationResponse navigationResponseArg: WKNavigationResponse, completion: @escaping (Result<NavigationResponsePolicy, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.decidePolicyForNavigationResponse"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func didFailNavigation(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, error errorArg: NSError, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.didFailNavigation"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func didFailProvisionalNavigation(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, error errorArg: NSError, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.didFailProvisionalNavigation"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
        channel.sendMessage([pigeonInstanceArg, webViewArg, errorArg] as [Any?]) { response in
            guard let listResponse = response as? [Any?] else {
                completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    func webViewWebContentProcessDidTerminate(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.webViewWebContentProcessDidTerminate"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func didReceiveAuthenticationChallenge(pigeonInstance pigeonInstanceArg: WKNavigationDelegate, webView webViewArg: WKWebView, challenge challengeArg: URLAuthenticationChallenge, completion: @escaping (Result<[Any?], PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKNavigationDelegate.didReceiveAuthenticationChallenge"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiNSObject: PigeonApiProtocolNSObject {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiNSObject?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSObject.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
        ...
        let addObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSObject.addObserver", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let removeObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSObject.removeObserver", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: NSObject, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSObject.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    func observeValue(pigeonInstance pigeonInstanceArg: NSObject, keyPath keyPathArg: String?, object objectArg: NSObject?, change changeArg: [KeyValueChangeKey: Any?]?, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSObject.observeValue"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
protocol PigeonApiDelegateUIViewWKWebView {
        ...
        /// macOS 11.
        func callAsyncJavaScript(pigeonApi: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, functionBody: String, arguments: [String: Any], completion: @escaping (Result<Any?, Error>) -> Void)
    #endif
    #if !os(macOS)
        /// A Boolean value that indicates whether you can inspect the view with
        /// Safari Web Inspector.
        func setInspectable(pigeonApi: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, inspectable: Bool) throws -> Bool
    #endif
    #if !os(macOS)
        /// The custom user agent string.
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIViewWKWebView?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(macOS)
            let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonIdentifierArg = args[0] as! Int64
                    ...
                    do {
                        try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                            api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, initialConfiguration: initialConfigurationArg),
                            withIdentifier: pigeonIdentifierArg
                        )
                        reply(wrapResult(nil))
                    } catch {
        ...
        #endif
        #if !os(macOS)
            let configurationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.configuration", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                configurationChannel.setMessageHandler { message, reply in
                    ...
                    let pigeonIdentifierArg = args[1] as! Int64
                    do {
                        try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.pigeonDelegate.configuration(pigeonApi: api, pigeonInstance: pigeonInstanceArg), withIdentifier: pigeonIdentifierArg)
                        reply(wrapResult(nil))
                    } catch {
                        reply(wrapError(error))
                    }
        ...
        #endif
        #if !os(macOS)
            let scrollViewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.scrollView", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                scrollViewChannel.setMessageHandler { message, reply in
                    ...
                    let pigeonIdentifierArg = args[1] as! Int64
                    do {
                        try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.pigeonDelegate.scrollView(pigeonApi: api, pigeonInstance: pigeonInstanceArg), withIdentifier: pigeonIdentifierArg)
                        reply(wrapResult(nil))
                    } catch {
                        reply(wrapError(error))
                    }
        ...
        #endif
        #if !os(macOS)
            let setUIDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setUIDelegate", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setNavigationDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setNavigationDelegate", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let getUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.getUrl", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                getUrlChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(macOS)
            let getEstimatedProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.getEstimatedProgress", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let loadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.load", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let loadHtmlStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.loadHtmlString", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let loadFileUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.loadFileUrl", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let loadFlutterAssetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.loadFlutterAsset", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let canGoBackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.canGoBack", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let canGoForwardChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.canGoForward", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let goBackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.goBack", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let goForwardChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.goForward", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let reloadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.reload", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let getTitleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.getTitle", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setAllowsBackForwardNavigationGesturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setAllowsBackForwardNavigationGestures", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setCustomUserAgentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setCustomUserAgent", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let evaluateJavaScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.evaluateJavaScript", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let callAsyncJavaScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.callAsyncJavaScript", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                callAsyncJavaScriptChannel.setMessageHandler { message, reply in
                    ...
                    api.pigeonDelegate.callAsyncJavaScript(pigeonApi: api, pigeonInstance: pigeonInstanceArg, functionBody: functionBodyArg, arguments: argumentsArg) { result in
                        switch result {
                        case let .success(res):
                            reply(wrapResult(res))
                        case let .failure(error):
        ...
        #endif
        #if !os(macOS)
            let setInspectableChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setInspectable", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setInspectableChannel.setMessageHandler { message, reply in
                    ...
                    do {
                        let result = try api.pigeonDelegate.setInspectable(pigeonApi: api, pigeonInstance: pigeonInstanceArg, inspectable: inspectableArg)
                        reply(wrapResult(result))
                    } catch {
                        reply(wrapError(error))
                    }
        ...
        #endif
        #if !os(macOS)
            let getCustomUserAgentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.getCustomUserAgent", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        #endif
        #if !os(macOS)
            let setAllowsLinkPreviewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.setAllowsLinkPreview", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
        ...
        func pigeonNewInstance(pigeonInstance: WKWebView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIViewWKWebView.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateNSViewWKWebView {
        ...
        /// [arguments] become local variables in [functionBody]. Requires iOS 14 or
        /// macOS 11.
        func callAsyncJavaScript(pigeonApi: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, functionBody: String, arguments: [String: Any], completion: @escaping (Result<Any?, Error>) -> Void)
    #endif
    #if !os(iOS)
        /// A Boolean value that indicates whether you can inspect the view with
        /// Safari Web Inspector.
        func setInspectable(pigeonApi: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, inspectable: Bool) throws -> Bool
    #endif
    #if !os(iOS)
        ...
        /// property.
        func setUnderPageBackgroundColor(pigeonApi: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, red: Double, green: Double, blue: Double, alpha: Double) throws -> Bool
    #endif
    #if !os(iOS)
        /// A Boolean value that indicates whether magnification gestures are
        /// enabled.
        func setAllowsMagnification(pigeonApi: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, allow: Bool) throws
    #endif
    #if !os(iOS)
        /// The custom user agent string.
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiNSViewWKWebView?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(iOS)
            let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonIdentifierArg = args[0] as! Int64
        ...
        #endif
        #if !os(iOS)
            let configurationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.configuration", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                configurationChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setUIDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setUIDelegate", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setUIDelegateChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setNavigationDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setNavigationDelegate", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setNavigationDelegateChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let getUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.getUrl", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                getUrlChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let getEstimatedProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.getEstimatedProgress", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                getEstimatedProgressChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let loadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.load", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                loadChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let loadHtmlStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.loadHtmlString", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                loadHtmlStringChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let loadFileUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.loadFileUrl", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                loadFileUrlChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let loadFlutterAssetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.loadFlutterAsset", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                loadFlutterAssetChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let canGoBackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.canGoBack", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                canGoBackChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let canGoForwardChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.canGoForward", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                canGoForwardChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let goBackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.goBack", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                goBackChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let goForwardChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.goForward", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                goForwardChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let reloadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.reload", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                reloadChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let getTitleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.getTitle", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                getTitleChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setAllowsBackForwardNavigationGesturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setAllowsBackForwardNavigationGestures", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setAllowsBackForwardNavigationGesturesChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setCustomUserAgentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setCustomUserAgent", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setCustomUserAgentChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let evaluateJavaScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.evaluateJavaScript", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                evaluateJavaScriptChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let callAsyncJavaScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.callAsyncJavaScript", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                callAsyncJavaScriptChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setInspectableChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setInspectable", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setInspectableChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setUnderPageBackgroundColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setUnderPageBackgroundColor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setUnderPageBackgroundColorChannel.setMessageHandler { message, reply in
                    ...
                    do {
                        let result = try api.pigeonDelegate.setUnderPageBackgroundColor(pigeonApi: api, pigeonInstance: pigeonInstanceArg, red: redArg, green: greenArg, blue: blueArg, alpha: alphaArg)
                        reply(wrapResult(result))
                    } catch {
                        reply(wrapError(error))
                    }
        ...
        #endif
        #if !os(iOS)
            let setAllowsMagnificationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setAllowsMagnification", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setAllowsMagnificationChannel.setMessageHandler { message, reply in
                    ...
                    let allowArg = args[1] as! Bool
                    do {
                        try api.pigeonDelegate.setAllowsMagnification(pigeonApi: api, pigeonInstance: pigeonInstanceArg, allow: allowArg)
                        reply(wrapResult(nil))
                    } catch {
                        reply(wrapError(error))
                    }
        ...
        #endif
        #if !os(iOS)
            let getCustomUserAgentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.getCustomUserAgent", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                getCustomUserAgentChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        #endif
        #if !os(iOS)
            let setAllowsLinkPreviewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.setAllowsLinkPreview", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                setAllowsLinkPreviewChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonInstanceArg = args[0] as! WKWebView
        ...
        func pigeonNewInstance(pigeonInstance: WKWebView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.NSViewWKWebView.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKWebView: PigeonApiProtocolWKWebView {
    ...
    func pigeonNewInstance(pigeonInstance: WKWebView, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebView.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKUIDelegate: PigeonApiProtocolWKUIDelegate {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKUIDelegate?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                let args = message as! [Any?]
                let pigeonIdentifierArg = args[0] as! Int64
    ...
    func onCreateWebView(pigeonInstance pigeonInstanceArg: WKUIDelegate, webView webViewArg: WKWebView, configuration configurationArg: WKWebViewConfiguration, navigationAction navigationActionArg: WKNavigationAction, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.onCreateWebView"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func requestMediaCapturePermission(pigeonInstance pigeonInstanceArg: WKUIDelegate, webView webViewArg: WKWebView, origin originArg: WKSecurityOrigin, frame frameArg: WKFrameInfo, type typeArg: MediaCaptureType, completion: @escaping (Result<PermissionDecision, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.requestMediaCapturePermission"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func runJavaScriptAlertPanel(pigeonInstance pigeonInstanceArg: WKUIDelegate, webView webViewArg: WKWebView, message messageArg: String, frame frameArg: WKFrameInfo, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.runJavaScriptAlertPanel"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    ...
    func runJavaScriptConfirmPanel(pigeonInstance pigeonInstanceArg: WKUIDelegate, webView webViewArg: WKWebView, message messageArg: String, frame frameArg: WKFrameInfo, completion: @escaping (Result<Bool, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.runJavaScriptConfirmPanel"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
        channel.sendMessage([pigeonInstanceArg, webViewArg, messageArg, frameArg] as [Any?]) { response in
            guard let listResponse = response as? [Any?] else {
                completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    func runJavaScriptTextInputPanel(pigeonInstance pigeonInstanceArg: WKUIDelegate, webView webViewArg: WKWebView, prompt promptArg: String, defaultText defaultTextArg: String?, frame frameArg: WKFrameInfo, completion: @escaping (Result<String?, PigeonError>) -> Void) {
        ...
        let binaryMessenger = pigeonRegistrar.binaryMessenger
        let codec = pigeonRegistrar.codec
        let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKUIDelegate.runJavaScriptTextInputPanel"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiWKHTTPCookieStore: PigeonApiProtocolWKHTTPCookieStore {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKHTTPCookieStore?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let setCookieChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKHTTPCookieStore.setCookie", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getAllCookiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKHTTPCookieStore.getAllCookies", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKHTTPCookieStore, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKHTTPCookieStore.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIScrollViewDelegate?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(macOS)
            let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollViewDelegate.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonIdentifierArg = args[0] as! Int64
        ...
        func pigeonNewInstance(pigeonInstance: UIScrollViewDelegate, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollViewDelegate.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
        ...
        func scrollViewDidScroll(pigeonInstance pigeonInstanceArg: UIScrollViewDelegate, scrollView scrollViewArg: UIScrollView, x xArg: Double, y yArg: Double, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIScrollViewDelegate.scrollViewDidScroll"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiURLCredential: PigeonApiProtocolURLCredential {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURLCredential?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let withUserChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLCredential.withUser", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            withUserChannel.setMessageHandler { message, reply in
                ...
                do {
                    try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                        api.pigeonDelegate.withUser(pigeonApi: api, user: userArg, password: passwordArg, persistence: persistenceArg),
                        withIdentifier: pigeonIdentifierArg
                    )
                    reply(wrapResult(nil))
                } catch {
        ...
        let withUserAsyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLCredential.withUserAsync", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let serverTrustAsyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLCredential.serverTrustAsync", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: URLCredential, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLCredential.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiURLProtectionSpace: PigeonApiProtocolURLProtectionSpace {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURLProtectionSpace?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let getServerTrustChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLProtectionSpace.getServerTrust", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: URLProtectionSpace, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLProtectionSpace.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiURLAuthenticationChallenge: PigeonApiProtocolURLAuthenticationChallenge {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURLAuthenticationChallenge?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let getProtectionSpaceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLAuthenticationChallenge.getProtectionSpace", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: URLAuthenticationChallenge, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URLAuthenticationChallenge.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiURL: PigeonApiProtocolURL {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURL?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let getAbsoluteStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.URL.getAbsoluteString", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: URL, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.URL.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiWKWebpagePreferences: PigeonApiProtocolWKWebpagePreferences {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKWebpagePreferences?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let setAllowsContentJavaScriptChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebpagePreferences.setAllowsContentJavaScript", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: WKWebpagePreferences, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.WKWebpagePreferences.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiGetTrustResultResponse: PigeonApiProtocolGetTrustResultResponse {
    ...
    func pigeonNewInstance(pigeonInstance: GetTrustResultResponse, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.GetTrustResultResponse.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
final class PigeonApiSecTrust: PigeonApiProtocolSecTrust {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiSecTrust?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let evaluateWithErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.evaluateWithError", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let copyExceptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.copyExceptions", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setExceptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.setExceptions", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getTrustResultChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.getTrustResult", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let copyCertificateChainChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.copyCertificateChain", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: SecTrustWrapper, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecTrust.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiSecCertificate: PigeonApiProtocolSecCertificate {
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiSecCertificate?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        let copyDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecCertificate.copyData", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
    ...
    func pigeonNewInstance(pigeonInstance: SecCertificateWrapper, completion: @escaping (Result<Void, PigeonError>) -> Void) {
        if pigeonRegistrar.ignoreCallsToDart {
            ...
            let binaryMessenger = pigeonRegistrar.binaryMessenger
            let codec = pigeonRegistrar.codec
            let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.SecCertificate.pigeon_newInstance"
            let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
            channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                guard let listResponse = response as? [Any?] else {
                    completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIColor?) {
        let codec: FlutterStandardMessageCodec =
            api != nil
                ...
                : FlutterStandardMessageCodec.sharedInstance()
        #if !os(macOS)
            let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIColor.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
            if let api = api {
                pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
                    let args = message as! [Any?]
                    let pigeonIdentifierArg = args[0] as! Int64
                    ...
                    do {
                        try api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                            api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, red: redArg, green: greenArg, blue: blueArg, alpha: alphaArg),
                            withIdentifier: pigeonIdentifierArg
                        )
                        reply(wrapResult(nil))
                    } catch {
        ...
        func pigeonNewInstance(pigeonInstance: UIColor, completion: @escaping (Result<Void, PigeonError>) -> Void) {
            if pigeonRegistrar.ignoreCallsToDart {
                ...
                let binaryMessenger = pigeonRegistrar.binaryMessenger
                let codec = pigeonRegistrar.codec
                let channelName = "dev.flutter.pigeon.xue_hua_webview_wkwebview.UIColor.pigeon_newInstance"
                let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
                channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
                    guard let listResponse = response as? [Any?] else {
                        completion(.failure(createConnectionError(withChannelName: channelName)))
