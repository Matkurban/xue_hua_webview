...
class UserScriptProxyAPIDelegate: PigeonApiDelegateWKUserScript {
    ...
    func source(pigeonApi _: PigeonApiWKUserScript, pigeonInstance: WKUserScript) throws -> String {
        return pigeonInstance.source
    }

    func injectionTime(pigeonApi _: PigeonApiWKUserScript, pigeonInstance: WKUserScript) throws
    ...
    func isForMainFrameOnly(pigeonApi _: PigeonApiWKUserScript, pigeonInstance: WKUserScript) throws
        -> Bool
    {
