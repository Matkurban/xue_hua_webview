...
@ConfigurePigeon(
  PigeonOptions(
    ...
    swiftOut:
        'darwin/xue_hua_webview_wkwebview/Sources/xue_hua_webview_wkwebview/WebKitLibrary.g.swift',
  ),
)
...
abstract class UIViewWKWebView extends UIView implements WKWebView {
  ...
  /// Evaluates the specified JavaScript function body and waits for a Promise.
  ///
  /// [arguments] become local variables in [functionBody]. Requires iOS 14 or
  /// macOS 11.
  @async
