...
import 'android_headless_webview.dart';
import 'android_webview_storage_manager.dart';
...
class AndroidWebViewPlatform extends WebViewPlatform {
  ...
  @override
  AndroidWebViewStorageManager createPlatformStorageManager(
    PlatformWebViewStorageManagerCreationParams params,
  ) {
    return AndroidWebViewStorageManager(params);
  }

  @override
  AndroidHeadlessWebView createPlatformHeadlessWebView(
    PlatformHeadlessWebViewCreationParams params,
  ) {
    return AndroidHeadlessWebView(params);
  }
}
