...
public class SslErrorTest {
  ...
  public void getPrimaryError() {
    ...
    final SslError instance = mock(SslError.class);
    final SslErrorType value = com.kurban.xue_hua_webview_android.SslErrorType.DATE_INVALID;
  ...
  public void hasError() {
    ...
    final SslError instance = mock(SslError.class);
    final SslErrorType error = com.kurban.xue_hua_webview_android.SslErrorType.DATE_INVALID;
