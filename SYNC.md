...
1. xue_hua_webview目录里的中英文README需要同步覆盖到根目录
2. xue_hua_webview目录里的中英文CHANGELOG需要同步覆盖到各个子插件
3. 也就是说只在主插件目录里维护一份即可

## 与官方插件包的同步

xue_hua_webview的主插件、interface、android、iOS/macOS、web插件都源自于官方插件（且需要兼容官方插件）。因此需要记录当前同步到了官方的哪个pub版本，以及该版本的更新时间。
...
| --- | --- | --- | --- | --- |
| `xue_hua_webview` | `webview_flutter` | `4.14.1` | `2026-07-08 01:29:37` | `4.14.1` |
| `xue_hua_webview_platform_interface` | `webview_flutter_platform_interface` | `2.15.1` | `2026-03-26 03:24:16` | `2.15.1` |
| `xue_hua_webview_android` | `webview_flutter_android` | `4.14.0` | `2026-08-12 06:10:16` | `4.14.0` |
| `xue_hua_webview_wkwebview` | `webview_flutter_wkwebview` | `3.26.0` | `2026-06-05 01:08:05` | `3.26.0` |
| `xue_hua_webview_web` | `webview_flutter_web` | `0.2.3+4` | `2024-11-13 05:49:07` | `0.2.3+4` |
